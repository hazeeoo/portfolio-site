...
- **Акцент**: Зеленый (#10b981) - можно изменить в `app/globals.css`
- **Фон**: Белый (светлая тема) / Почти черный (темная тема)

### Шрифты

- **Основной**: Inter (заголовки и текст)
- **Моноширинный**: JetBrains Mono (код и технологии)
